  ...
  return (
    <div className="bg-gray-900 flex items-center justify-center h-screen ">
      ...
      <div className="text-2xl text-center font-bold text-white">
        ...
        <div className={`text-xl transition-opacity duration-1000 ease-in-out delay-700 ${boot ? "opacity-100" : "opacity-0"}`}>
            I am a full-stack web developer with a passion for creating web applications that are both functional and beautiful.
        </div>

        <div className={`text-xl m-4 transition-opacity duration-2000 ease-in-out delay-1000 ${boot ? "opacity-100" : "opacity-0"}`}>
